...
(cl:in-package begin_tutorial-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name begin_tutorial-msg:<Num> is deprecated: use begin_tutorial-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader begin_tutorial-msg:num-val is deprecated.  Use begin_tutorial-msg:num instead.")
  (num m))
